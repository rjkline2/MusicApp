...
namespace MusicApp.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AlbumID,AlbumTitle,ArtistID,PubDate,AlbumArt")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AlbumID,AlbumTitle,ArtistID,PubDate,AlbumArt")] Album album)
        {
            if (ModelState.IsValid)
            {
